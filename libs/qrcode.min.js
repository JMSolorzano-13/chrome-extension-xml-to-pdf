/**
 * @sdd-task: Task #1 - Replace /libs stubs with real binaries
 * @sdd-spec: specs/spec-003-s4k-pdf-generator-pdfmake-qr/spec.md
 * @sdd-decision: ADR-007 - Reemplazo obligatorio de stubs /libs
 * @sdd-why: Offline pdfmake 0.2.12 + vfs_fonts + qrcode 1.5.4 (QRCode.toDataURL); no CDN at runtime
 */
